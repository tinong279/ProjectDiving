setInterval(() => {
  ...
  if (topBackground.style.backgroundImage == 'url("./1.潛水網站/images/綠島.jpg")') {
    topBackground.style.backgroundImage = 'url("./1.潛水網站/images/蘭嶼八代灣沈船.jpg")';
  } else if (
    topBackground.style.backgroundImage == 'url("./1.潛水網站/images/蘭嶼八代灣沈船.jpg")'
  ) {
    topBackground.style.backgroundImage = 'url("./1.潛水網站/images/小琉球.jpeg")';
  } else {
    topBackground.style.backgroundImage = 'url("./1.潛水網站/images/綠島.jpg")';
  }
}, 2500);
